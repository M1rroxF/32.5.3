...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v3.7.3"
  WORKING_DIRECTORY "D:/Programming/c++/skillbox/cmake-build-debug/_deps/json-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Programming/c++/skillbox/cmake-build-debug/_deps/json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Programming/c++/skillbox/cmake-build-debug/_deps/json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
